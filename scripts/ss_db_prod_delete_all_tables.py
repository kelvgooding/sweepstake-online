...
# append all database tables to tables list, excluding gn_horses, ss_group, ss_group_hosts

for i in c.execute("SELECT name FROM sqlite_master where name <> 'gn_horses' and name <> 'ss_group' and name <> 'ss_group_hosts';"):
    tables.append(i[0])
